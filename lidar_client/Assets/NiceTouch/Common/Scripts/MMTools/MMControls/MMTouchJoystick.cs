...
namespace MoreMountains.Tools 
{
	...
	public class MMTouchJoystick : MonoBehaviour, IDragHandler, IEndDragHandler
	{
		...
		public void MoveStickTowards (Vector2 screenPosition) {
			...
			{
				_newTargetPosition = TargetCamera.ScreenToWorldPoint((Vector3)screenPosition);
			}
			// otherwise
			else
			{
				_newTargetPosition = (Vector3)screenPosition;
			}
