Shader "Custom/heightmap_rotated"
{
	Properties
	{
		...
		_StartingHeightOffset("Starting Height Offset", Float) = 0 // use this to tweak the start offset from reference plane
	}
...
#pragma exclude_renderers gles
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			//pos.y += _StartingHeightOffset;

			IN.worldPos = mul(_CustomMatrix, pos) + _Height_2; // probably don't really need the whole 0 - 2 range so doing this for now
